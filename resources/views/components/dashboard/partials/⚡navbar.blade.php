...
<div>
    <!-- Top Header -->
    <header
        class="h-16 bg-[#111827]/80 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-4 md:px-8 sticky top-0 z-10">
        <div class="flex items-center">
            <!-- Mobile Menu Button -->
            <button @click="sidebarOpen = true" class="md:hidden mr-4 text-slate-400 hover:text-white transition-colors">
            ...
            <div
                class="hidden md:flex items-center bg-[#1e293b] rounded-full px-4 py-2 w-96 border border-slate-700/50 hover:border-slate-600 transition-colors">
        ...
        <div class="flex items-center space-x-3 md:space-x-5">
            ...
            <div class="flex items-center space-x-2 md:space-x-3 cursor-pointer group">
                <img src="{{ $user['avatar'] }}" alt="Avatar"
                    class="w-8 h-8 md:w-9 md:h-9 rounded-full ring-2 ring-slate-800 group-hover:ring-blue-500 transition-all"
                    loading="lazy">
