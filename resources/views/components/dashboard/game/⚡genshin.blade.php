                                                ...
                                                <div
                                                    ...
                                                    @if (!empty($offering['icon']))
                                                        <img src="{{ $offering['icon'] }}"
                                                            class="w-4 h-4 object-contain" loading="lazy">
                                                    @endif
                                                    <span
                                                        class="text-slate-300 truncate max-w-[120px]">{{ $offering['name'] ?? '' }}</span>
                                                    <span
                                                        class="text-amber-400 font-bold ml-1">Lv.{{ $offering['level'] ?? 0 }}</span>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                    ...
                    <div
                        ...
                        @if (empty($event_calendar))
                            <div class="flex items-center justify-center min-h-[200px] text-center">
                                <div>
                                    <svg class="w-16 h-16 text-slate-500 mx-auto mb-4" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        ...
                                        @foreach ($event_calendar['act_list'] as $event)
                                            <div
                                                ...
                                                @if (!empty($event['reward_list']))
                                                    <div
                                                        class="flex flex-wrap gap-1.5 mt-auto pt-3 border-t border-slate-700/50">
